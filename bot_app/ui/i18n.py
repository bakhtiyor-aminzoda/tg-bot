...
_TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        "profile.nav_overview": "Профиль",
        "profile.nav_referrals": "Рефералы",
        "profile.button_share_link": "Поделиться ссылкой",
        "profile.button_leaderboard": "Топ рефералов",
        "profile.overview_title": "👤 Ваш профиль",
        "profile.plan_summary": "Тариф: {plan}",
        "profile.daily_usage": "Дневной лимит: {usage}",
        "profile.monthly_usage": "Месячный лимит: {usage}",
        "profile.bonus_line": "Активные бонусы: +{daily}/день · +{monthly}/мес",
        "profile.bonus_none": "Активных бонусов нет.",
        "profile.next_reset_daily": "Сброс дневного лимита: {timestamp}",
        "profile.next_reset_monthly": "Сброс месячного лимита: {timestamp}",
        "profile.overview_unavailable": "Информация о тарифе временно недоступна.",
        "profile.referral_title": "🤝 Реферальная программа",
        "profile.referral_link": "Ваша ссылка: {link}",
        "profile.referral_link_missing": "Не удалось сформировать ссылку. Попробуйте позже.",
        "profile.referral_stats": "Подтверждено: {rewarded} · В ожидании: {pending}",
        "profile.referral_bonus_line": "Бонусы от рефералов: +{daily}/день · +{monthly}/мес",
        "profile.referral_bonus_none": "Пока без реферальных бонусов.",
        "profile.referral_hint": "Скиньте ссылку другу — он стартует бот и автоматически привяжется к вам.",
    },
    "en": {
        "status.waiting": (
            "🎯 Platform: {platform}\n"
        ...
        "profile.nav_overview": "Profile",
        "profile.nav_referrals": "Referrals",
        "profile.button_share_link": "Share link",
        "profile.button_leaderboard": "Referral leaderboard",
        "profile.overview_title": "👤 Your profile",
        "profile.plan_summary": "Plan: {plan}",
        "profile.daily_usage": "Daily usage: {usage}",
        "profile.monthly_usage": "Monthly usage: {usage}",
        "profile.bonus_line": "Active bonuses: +{daily}/day · +{monthly}/month",
        "profile.bonus_none": "No active bonuses yet.",
        "profile.next_reset_daily": "Daily reset: {timestamp}",
        "profile.next_reset_monthly": "Monthly reset: {timestamp}",
        "profile.overview_unavailable": "Plan information is temporarily unavailable.",
        "profile.referral_title": "🤝 Referral program",
        "profile.referral_link": "Your link: {link}",
        "profile.referral_link_missing": "Referral link is not available right now.",
        "profile.referral_stats": "Confirmed: {rewarded} · Pending: {pending}",
        "profile.referral_bonus_line": "Referral bonuses: +{daily}/day · +{monthly}/month",
        "profile.referral_bonus_none": "No referral bonuses yet.",
        "profile.referral_hint": "Share the link — once a friend starts the bot they are linked to you.",
    },
}
